...
**Баримт бичиг:** `docs/08-security.mn.md`
**Төсөл:** Ногоолин — Шашны Бүтээгдэхүүний Каталог Платформ
**Хувилбар:** 1.2.0
**Төлөв:** Ноорог
**Зохиогч:** Тэнгис (Хөгжүүлэгч)
**Сүүлд шинэчилсэн:** 2026 оны 7-р сар
**Хамааралтай баримт:** [`docs/02-requirements.mn.md`](./02-requirements.mn.md), [`docs/04-er-diagram.mn.md`](./04-er-diagram.mn.md), [`docs/05-sequence-diagrams.mn.md`](./05-sequence-diagrams.mn.md), [`docs/06-api-spec.yaml`](./06-api-spec.yaml)
...
Энэхүү баримт бичиг нь Ногоолины аюулгүй байдлын архитектурыг нэг лавлагаа болгон нэгтгэнэ. Хэдийгээр тусдаа аюулгүй байдлын шаардлагууд [`docs/02-requirements.mn.md`](./02-requirements.mn.md)-ийн (4.2 хэсэг, NFR-SEC-001 - NFR-SEC-013) болон [`SEQ-004`](./05-sequence-diagrams.mn.md)-д харагддаг боловч энэхүү баримт бичиг нь дараах зүйлсийн **нэг итгэмжит эх үүсвэр** болно:
...
> **Аюулгүй байдал нь backend-ийн эхний мөр кодоос өмнө загварчлагддаг** (Төслийн Хязгаарлалт, `01-vision.mn.md` §11).
...
[`SEQ-004`](./05-sequence-diagrams.mn.md) нь нэг admin-д зориулсан mutation дээр 4 давхарга дараалан ажиллаж байгаагийн жишээ болно:
...
> **Чухал дүрэм:** хэрэглэгчид өөрийн `role`-ийг `admin` болгон тохируулах боломжийг олгодог **ямар ч API endpoint байхгүй**. Анхны admin бүртгэл нь гараар bootstrap хийгддэг ([`09-deployment.mn.md`](./09-deployment.mn.md) §9-г үзнэ үү).
...
Анхны үйлдвэрлэлийн байршуулалтаас өмнө (`09-deployment.mn.md`) болон `delivery_enabled = true` болгохоос өмнө гараар гүйцэтгэнэ.
...
- [ ] `audit_logs`-т **UPDATE/DELETE policy байхгүйг** батлагдсан:
      ...
      ```
- [ ] Анхны admin бүртгэл шууд SQL/Supabase dashboard-аар bootstrap хийгдсэн (ямар ч API endpoint-ээр биш) — `09-deployment.mn.md`-г үзнэ үү
...
*Өмнөх баримт бичиг: [`docs/06-api-spec.yaml`](./06-api-spec.yaml)*
*Дараагийн баримт бичиг: [`docs/09-deployment.mn.md`](./09-deployment.mn.md)*
