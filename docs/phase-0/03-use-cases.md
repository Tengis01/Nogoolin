...
**Document:** `docs/phase-0/03-use-cases.md`  
...
*Previous document: [`docs/phase-0/02-requirements.md`](02-requirements.md)*  
*Next document: [`docs/phase-0/04-er-diagram.md`](04-er-diagram.md)*
