...
**Баримт бичиг:** `docs/phase-0/04-er-diagram.mn.md`  
**Төсөл:** Ногоолин — Шашны Бүтээгдэхүүний Каталог Платформ  
**Хувилбар:** 1.0.0  
**Төлөв:** Ноорог  
**Зохиогч:** Тэнгис (Хөгжүүлэгч)  
**Сүүлд шинэчилсэн:** 2026 оны 6-р сар  
**Хамааралтай баримт:** [`docs/phase-0/02-requirements_mn.md`](./02-requirements_mn.md)
...
*Өмнөх баримт бичиг: [`docs/phase-0/03-use-cases.mn.md`](03-use-cases.mn.md)*  
*Дараагийн баримт бичиг: [`docs/phase-0/05-sequence-diagrams_mn.md`](./05-sequence-diagrams_mn.md)*