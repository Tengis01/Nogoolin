...
**Баримт бичиг:** `docs/phase-0/09-deployment_mn.md`
**Төсөл:** Ногоолин — Шашны Бүтээгдэхүүний Каталог Платформ
**Хувилбар:** 1.2.0
**Төлөв:** Ноорог
**Зохиогч:** Тэнгис (Хөгжүүлэгч)
**Сүүлд шинэчилсэн:** 2026 оны 7-р сар
**Хамааралтай баримт:** [`docs/phase-0/06-api-spec.yaml`](06-api-spec.yaml), [`docs/phase-0/08-security_mn.md`](./08-security_mn.md)
...
`04-er-diagram.mn.md`, `08-security_mn.md` §6
...
Migration-ууд `supabase/migrations/`-д байрлаж, дараалан дугаарлагддаг. Анхны migration (`0001_init.sql`) нь `08-security_mn.md` §6-аас бүх policy-тойгоор RLS идэвхжүүлсэн 11 хүснэгтийг үүсгэнэ:
...
Supabase SQL editor-д энэ query-г ажиллуулна (§13.3 of `08-security_mn.md`):
...
> Энэ trigger нь `SECURITY DEFINER` болгон ажиллана (RLS-ийг тойрдог) учир нь бүртгүүлэх явцад `public.users`-д бичдэг бөгөөд хэрэглэгч хүчинтэй сессгүй байдаг. `08-security_mn.md` §6.2-д заасны дагуу RLS тойрох хоёр хууль ёсны хэрэглээний нэг нь энэ (нөгөө нь `service_role` аудит бүртгэлийн бичлэг).
...
# ── CORS ─────────────────────────────────────────────────────────
# Зөвшөөрөгдсөн origin-уудын таслалаар тусгаарлагдсан жагсаалт (08-security_mn.md §4.2)
...
Vercel → Төсөл → Тохиргоо → Environment Variables-д тохируулна. **Чухал:** зөвхөн `NEXT_PUBLIC_` угтвартай хувьсагчууд хөтчийн bundle-д нээлттэй болдог — `SUPABASE_SERVICE_ROLE_KEY` **хэзээ ч** энд гарахгүй (`08-security_mn.md` §11.2).
...
**Лавлагаа:** `08-security_mn.md` §3 (1-р Давхарга — Cloudflare WAF)
...
> **Хоёр шатлалт нэвтрүүлэлт:** Vercel болон Railway нь бодит origin-д Let's Encrypt TLS гэрчилгээ гаргаж авч чадахын тулд **DNS only (саарал үүл)** болгон эхэлнэ. Хоёулаа хүчинтэй HTTPS харуулсаны дараа **Proxied (улбар шар үүл)** болгон сэлгэнэ — Cloudflare-ийн WAF, CDN, DDoS хамгаалалтыг идэвхжүүлнэ (1-р давхарга, `08-security_mn.md` §3).
...
|---|---|---|
| SSL/TLS шифрлэлтийн горим | **Full (Strict)** | Vercel/Railway-ийн TLS гэрчилгээг шалгана — Cloudflare-оос origin руу MITM-ийг сэргийлнэ (NFR-SEC-001, `08-security_mn.md` §3.2) |
...
`08-security_mn.md` §3.2-д заасны дагуу `/api/*` болон `/admin/*` нь Cloudflare-ийн edge cache-ийг тойрох ёстой.
...
> Энэ нь Fastify-ийн түвшний хязгаарын (`08-security_mn.md` §4.3) дээрх **бүдүүлэг буфер** юм. 300/мин нь санаатайгаар сул байдаг — зорилго нь хэт хэт ашиглалтыг (жишээ нь, ажиллаж байгаа скрипт) зогсоох явдал, бизнесийн дүрмийг хэрэгжүүлэх биш.
...
**Лавлагаа:** `08-security_mn.md` §5.3 — "хэрэглэгчид өөрийн `role`-ийг `admin` болгон тохируулах боломжийг олгодог ямар ч API endpoint байхгүй"
...
> Энэ нь Supabase dashboard-ийн SQL editor ашиглан **мэдээллийн санд шууд бичих** бөгөөд өргөтгөгдсөн (postgres superuser) эрхтэйгээр ажилладаг — RLS-ийг бүрэн тойрдог, энэ нь хүлээгдэж буй бөгөөд `role = 'admin'` тохируулах **цорын ганц** арга юм (§5.3 of `08-security_mn.md`).
...
Энэ нь MVP-ийн амжилтын хэмжүүр "Мобайл апп хоёр платформд дотоод тестийг давсан байх" (`01-vision_mn.md` §8)-ийг Android-д хангана. iOS дотоод тест **EAS Submit → TestFlight**-ийг ашиглах бөгөөд өмнөх адил идэвхтэй Apple Developer бүртгэл шаарддаг — энэ шаардлага framework солигдсонтой хамааралгүй.
...
> React Native апп нь вэб апптай **ижил `SUPABASE_ANON_KEY`** ашигладаг (§6.2) — энэ key нь нийтэд нээлттэй байхаар загварчлагдсан бөгөөд хөтчийн client-тэй адил хүсэлт бүрт RLS-д захирагддаг (`08-security_mn.md` §6.2).
...
**Лавлагаа:** `08-security_mn.md` §13 (Аюулгүй Байдлын Шалгах Жагсаалт)-тай байршуулалтын тодорхой шалгалтуудыг нэгтгэнэ. Анхны үйлдвэрлэлийн нэвтрүүлэлтийн өмнө **дарааллаар** гүйцэтгэнэ.
...
- [ ] Бүтээгдэхүүний дэлгэрэнгүй хуудас Lighthouse **SEO** оноо ≥ 90 (`01-vision_mn.md` §8)
...
`08-security_mn.md` §12.1-д заасны дагуу хяналт нь аль хэдийн байгаа тус бүрийн платформын dashboard-уудад тулгуурладаг — MVP-д нэмэлт хэрэгсэл нэмэгдэхгүй:
...
`01-vision_mn.md` §6 (Personal Kanban — "Бям гараг бүр 30 минутын тойм хийнэ")-д заасны дагуу давтагдах шалгах жагсаалтын зүйл нэмнэ:
...
4. **Аюулгүй байдлын осол (жишээ нь нууц мэдээлэл алдагдсан):** нөлөөлсөн нууц мэдээлэлийг тэр дороо хамаарах dashboard-д сэлгэнэ (Supabase / Railway / Vercel), шинэ утгатай дахин байршуулна (`08-security_mn.md` §11.2 дүрэм 5)

### 12.4 Өргөтгөлийн Өдөөгч (Ирээдүйн Лавлагаа)

Эдгээр нь **MVP-ийн санаа зовоол биш** гэхдээ ирээдүйн Тэнгис `08-security_mn.md` §4.3 (дотор санах ойн rate limiting) болон NFR-SCA-001 (хэвтээ өргөтгөл) дахин хянах цагийг мэдэхийн тулд баримтлагдсан:
...
| >1 API instance шаардлагатай | Rate-limit төлвийг дотор санах ойгоос Redis рүү шилжүүлнэ (`08-security_mn.md` §4.3 тэмдэглэл) |
| Supabase үнэгүй tier storage/bandwidth хязгаарт ойртоно | Supabase Pro болгон дэвшүүлнэ |
| `delivery_enabled = true` идэвхжүүлэлт ойртоно | `08-security_mn.md` §13.6 шалгах жагсаалтыг дахин гүйцэтгэнэ |

---

*Өмнөх баримт бичиг: [`docs/phase-0/08-security_mn.md`](./08-security_mn.md)*
*Энэ нь Phase 0-ийн эцсийн баримт бичиг юм. Phase 1 (Foundation) нь `01-vision_mn.md` §6 замын зургийн дагуу monorepo scaffolding-аар эхэлнэ.*
