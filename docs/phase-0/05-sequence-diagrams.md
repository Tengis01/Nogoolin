...
**Document:** `docs/phase-0/05-sequence-diagrams.md`  
**Project:** Nogoolin — Premium Religious Product Catalog Platform  
**Version:** 1.1.0  
**Status:** Draft  
**Author:** Tengis (Solo Developer)  
**Last Updated:** July 2026  
**Depends On:** [`docs/phase-0/03-use-cases.md`](03-use-cases.md), [`docs/phase-0/04-er-diagram.md`](04-er-diagram.md)
...
Each diagram references the corresponding use case in [`docs/phase-0/03-use-cases.md`](03-use-cases.md) and requirements in [`docs/phase-0/02-requirements.md`](02-requirements.md).
...
*Previous document: [`docs/phase-0/04-er-diagram.md`](04-er-diagram.md)*  
*Next document: [`docs/phase-0/06-api-spec.yaml`](06-api-spec.yaml)*