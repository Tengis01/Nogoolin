...
**Баримт бичиг:** `docs/phase-0/05-sequence-diagrams_mn.md`  
**Төсөл:** Ногоолин — Шашны Бүтээгдэхүүний Каталог Платформ  
**Хувилбар:** 1.1.0  
**Төлөв:** Ноорог  
**Зохиогч:** Тэнгис (Хөгжүүлэгч)  
**Сүүлд шинэчилсэн:** 2026 оны 7-р сар  
**Хамааралтай баримт:** [`docs/phase-0/03-use-cases.mn.md`](03-use-cases.mn.md), [`docs/phase-0/04-er-diagram.mn.md`](04-er-diagram.mn.md)
...
|---|---|---|---|
| 1.1.0 | 2026 оны 7-р сар | MINOR | Мобайл платформын лавлагаа шинэчлэгдлээ: Flutter → React Native + Expo (SEQ-001 тэмдэглэл) |
...
Диаграм бүр [`docs/phase-0/03-use-cases.mn.md`](03-use-cases.mn.md)-ийн холбогдох хэрэглэх тохиолдол болон [`docs/phase-0/02-requirements_mn.md`](./02-requirements_mn.md)-ийн шаардлагыг лавлана.
...
- Мобайл (React Native + Expo) нь WebView ашиглахгүйгээр `@react-native-google-signin`-ээр дамжуулан native `signInWithIdToken` ашиглана (FR-AUTH-002) — мэдээллийн сангийн trigger логик ижил хэвээр байна.
...
*Өмнөх баримт бичиг: [`docs/phase-0/04-er-diagram.mn.md`](04-er-diagram.mn.md)*  
*Дараагийн баримт бичиг: [`docs/phase-0/06-api-spec.yaml`](06-api-spec.yaml)*