...
**Document:** `docs/phase-0/04-er-diagram.md`  
**Project:** Nogoolin — Premium Religious Product Catalog Platform  
**Version:** 1.0.0  
**Status:** Draft  
**Author:** Tengis (Solo Developer)  
**Last Updated:** June 2026  
**Depends On:** [`docs/phase-0/02-requirements.md`](02-requirements.md)
...
*Previous document: [`docs/phase-0/03-use-cases.md`](03-use-cases.md)*  
*Next document: [`docs/phase-0/05-sequence-diagrams.md`](05-sequence-diagrams.md)*