...
// 360° badge for products with a 3D model.
//
// The card is a wrapper div, NOT a <Link> around everything: the Phase 4
// save toggle is a <button>, and a button nested inside an anchor is invalid
// HTML (and steals the click). The link covers the content; the button is an
...
export function ProductCard({
  ...
  return (
    <div className="group relative rounded-[18px] border border-[var(--hair)] bg-[var(--paper)] transition-all duration-[350ms] hover:-translate-y-1 hover:border-[var(--act)] hover:shadow-[0_20px_44px_rgba(23,53,42,0.10)]">
