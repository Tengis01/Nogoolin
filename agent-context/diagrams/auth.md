...
> Regenerated from `docs/phase-0/05-sequence-diagrams.md` SEQ-001 (labels updated
...
- Admin role is NEVER set via OAuth — first admin promoted by direct SQL
  (docs/phase-0/09 §9), subsequent admins via `PATCH /admin/users/{id}` by an existing admin.
