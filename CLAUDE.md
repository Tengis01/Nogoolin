...
Phases 1–3 of `docs/phase-0/10-roadmap.md`; Phase 0 (documentation) is complete.
...
| Doc | Content |
|---|---|
| `docs/phase-0/01-vision.md` | Vision, MVP scope, non-goals, constraints |
| `docs/phase-0/02-requirements.md` | FR-/NFR- requirements (MoSCoW priorities) |
| `docs/phase-0/03-use-cases.md` | Use cases |
| `docs/phase-0/04-er-diagram.md` | Database schema — 11 entities, indexes, RLS notes |
| `docs/phase-0/05-sequence-diagrams.md` | Key flows |
| `docs/phase-0/06-api-spec.yaml` | OpenAPI spec (23 paths / 28 operations) |
| `docs/phase-0/07-uiux-wireframes.md` | UI/UX wireframes (highest precedence) |
| `docs/phase-0/08-security.md` | 4-layer security design, RLS policies, secrets rules |
| `docs/phase-0/09-deployment.md` | Supabase/Railway/Vercel/Cloudflare + CI/CD |
| `docs/phase-0/10-roadmap.md` | Phase plan, finalized decisions, working rules |
...
> Note: `docs/phase-0/09-deployment.md` §1.3 shows an older sketch (`apps/api`).
> `backend/api` is the finalized API location per `docs/phase-0/10-roadmap.md`
...
## Security & Secrets (per docs/phase-0/08-security.md §11)
...
## Key Working Rules (docs/phase-0/10-roadmap.md §10)
...
## Documentation layout update (2026-09-15)

Numbered Phase 0 sources now live in `docs/phase-0/` (01–10). They remain source material; the scoped M2 SRS is a draft in `docs/requirements/` and design decisions are in `docs/architecture/sdd-template.md`. Explicit scoped changes and source/code gaps are recorded there; do not silently equate the legacy Phase 0 material with an approved SRS. Course files and PDF deliverables live in `docs/ICSI405/`; this is the course-only area requested by the owner.
